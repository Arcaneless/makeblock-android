...
extend(MBlockly.Control, {
  ...
  deviceInfo: {
    type: "auriga",
    portlist: MBlockly.Control.SETTING.PORT["auriga"]
  },
...
extend(MBlockly.Control, {
  ...
  // 读取智能舵机的角度: ff 55 06 00 01 40 0d 05 01
  // 返回信息：FF 55 00 06 68 01 00 00 0D 0A
  ...
  // 1: 设置智能舵机锁定/解锁: ff 55 07 00 02 40 01 05 01 00
  ...
  // 2: 设置智能舵机全彩LED灯的颜色: ff 55 09 00 02 40 02 05 01 ff 00 00
  ...
  // 3: 设置智能舵机握手指令: ff 55 06 00 02 40 03 05 01
  ...
  // 4: 设置智能舵机绝对角度: ff 55 0e 00 02 40 04 05 01 68 01 00 00 00 00 48 42
  ...
  // 5: 设置智能舵机相对角度转动: ff 55 0e 00 02 40 05 05 01 68 01 00 00 00 00 48 42
  ...
  // 6: 设置智能舵机直流模式转动: ff 55 08 00 02 40 06 05 01 96 00
  ...
  // 7: 设置智能舵机当前位置为零点: ff 55 06 00 02 40 07 05 01
  ...
  // 8: 设置智能舵机回到初始位置: ff 55 06 00 02 40 08 05 01
...
extend(MBlockly.Control, {
  ...
  sensor_callback: function(type, buf) {
    ...
    if (type == this.PromiseType.SMART_SERVO_ANGLE.index) {
      result = -1 * result;
    }
