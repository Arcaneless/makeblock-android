...
MBlockly.Airblock = {
    ...
    airblockSetBoardOffsetAngle: function(jsonData) {
        console.log('airblockSetBoardOffsetAngle' + jsonData);

        var pitchAngle = jsonData.pitchAngle;
        var rollAngle = jsonData.rollAngle;
        var yawAngle = jsonData.yawAngle;

        var index = 1;
        MBlockly.Neurons.engine.sendBlockCommand('AIRBLOCK', "SETBOARDOFFSETANGLE",[pitchAngle,rollAngle,yawAngle], index);
    },

    airblockGetBoardOffsetAngle: function() {
        console.log('airblockGetBoardOffsetAngle');

        var index = 1;
        MBlockly.Neurons.engine.sendBlockCommand('AIRBLOCK', "GETBOARDOFFSETANGLE", [], index);
        var val = MBlockly.Neurons.engine.getBlockSubStatus('AIRBLOCK', "BOARDOFFSETANGLE", index);
        return val;
    },

    airblockSetHoveringDriftVelocity: function(jsonData) {
        console.log('airblockSetHoveringDriftVelocity' + jsonData);
        ...
        var index = 1;
        MBlockly.Neurons.engine.sendBlockCommand('AIRBLOCK', "SETHOVERINGDRIFTVELOCITY",[x,y,z], index);
    },

    airblockSetYawControl: function(jsonData) {
        console.log('airblockSetYawControl' + jsonData);

        var value = jsonData.value;

        var index = 1;
        MBlockly.Neurons.engine.sendBlockCommand('AIRBLOCK', "SETYAWCONTROL",[value], index);
    },

    airblockAdjusting: function(jsonData) {
        console.log('airblockAdjusting' + jsonData);

        var type = jsonData.type;

        var index = 1;
        MBlockly.Neurons.engine.sendBlockCommand('AIRBLOCK', "ADJUSTING",[type], index);
    },
