...
describe('Blocks', function() {
    ...
    describe('block_move', function() {
        ...
        describe('#move_turn', function() {
            var xml = '<xml xmlns="http://www.w3.org/1999/xhtml">\
                  <block type="move_turn" id="gjBHMJZa60B23gro3ygn" x="88" y="188">\
                    <field name="DIRECTION">LEFT</field>\
                    <value name="SPEED">\
                      <block type="math_number" id="u1hAiKVAC1M538Wf1Apd">\
                        <field name="NUM">100</field>\
                      </block>\
                    </value>\
                  </block>\
            ...
            var protocols = {
                "mcore": ["ff 55 06 00 02 0a 09 64 00", "ff 55 06 00 02 0a 0a 64 00"],
                "orion": ["ff 55 06 00 02 0a 09 64 00", "ff 55 06 00 02 0a 0a 64 00"],
                "auriga": ["ff 55 07 00 02 3d 00 01 9c ff", "ff 55 07 00 02 3d 00 02 9c ff"],
                "megaPi": ["ff 55 07 00 02 3d 00 01 9c ff", "ff 55 07 00 02 3d 00 02 9c ff"]
            };
            ...
            // 验证 block 块生成的代码是否正确
            it('should get code "blockly_js_func_move_turn("100","LEFT");"', function() {
                expect('blockly_js_func_move_turn("100","LEFT");').to.eql(code);
            });
        ...
        //move_set_dc_motor
        describe('#move_set_dc_motor', function() {
            var xml = '<xml xmlns="http://www.w3.org/1999/xhtml">\
                  <block type="move_set_dc_motor" id="5cHXMeB43bDHVkIg8nuf" x="-62" y="138">\
                    <field name="PORT">PORT-1</field>\
                    <value name="SPEED">\
                      <block type="math_number" id="CmzKzwQSFTZMW4UynLz9">\
                        <field name="NUM">100</field>\
                      </block>\
                    </value>\
                  </block>\
            ...
            var protocols = {
                // "mcore": ["ff 55 06 00 02 0a 09 9c ff"],  //mcore 的 port 不同
                "orion": ["ff 55 06 00 02 0a 01 64 00"],
                "auriga": ["ff 55 06 00 02 0a 01 64 00"],
                "megaPi": ["ff 55 06 00 02 0a 01 64 00"]
            };
            ...
            // 验证 block 块生成的代码是否正确
            it('should get code "blockly_js_func_move_set_dc_motor("PORT-1","100");"', function() {
                expect('blockly_js_func_move_set_dc_motor("PORT-1","100");').to.eql(code);
            });
            ...
            function doIt(type) {
                it('should get 【' + i + '】left motor cmd: 【' + protocols[i][0] + '】', function(done) {
                    testProtocol(type, code, protocols, done, function() {
                        expect(protocols[type][0]).to.eql(cmdList[0]);
                    });
                });
        ...
        //move_set_servo_motor
        describe('#move_set_servo_motor', function() {
            var xml = '<xml xmlns="http://www.w3.org/1999/xhtml">\
                  <block type="move_set_servo_motor" id="pbWJ65Ldy8SdKTRJ6IzW" x="-713" y="212">\
                    <field name="PORT">PORT-6</field>\
                    <field name="SLOT">SLOT-1</field>\
                    <value name="DEGREE">\
                      <block type="math_number" id="QpjgYOEdWrTjF3f20AMJ">\
            ...
            var protocols = {
                "mcore": ["ff 55 06 00 02 0b 01 01 5a"],
                "orion": ["ff 55 06 00 02 0b 01 01 5a"],
                "auriga": ["ff 55 06 00 02 0b 01 01 5a"],
                "megaPi": ["ff 55 06 00 02 0b 01 01 5a"]
            };
            ...
            // 验证 block 块生成的代码是否正确
            it('should get code "blockly_js_func_move_set_servo_motor("PORT-6","SLOT-1","90");"', function() {
                expect('blockly_js_func_move_set_servo_motor("PORT-6","SLOT-1","90");').to.eql(code);
            });
        ...
        //move_stop
        describe('#move_stop', function() {
            var xml = '<xml xmlns="http://www.w3.org/1999/xhtml">\
                    <block type="move_stop" id="IAaLsKLAFX8FI21JJBqj" x="-638" y="237"></block>\
                </xml>';

            var protocols = {
                "mcore": ["ff 55 06 00 02 0a 09 00 00", "ff 55 06 00 02 0a 0a 00 00"],
                "orion": ["ff 55 06 00 02 0a 09 00 00", "ff 55 06 00 02 0a 0a 00 00"],
                "auriga": ["ff 55 07 00 02 3d 00 01 00 00", "ff 55 07 00 02 3d 00 02 00 00"],
                "megaPi": ["ff 55 07 00 02 3d 00 01 00 00", "ff 55 07 00 02 3d 00 02 00 00"]
            };
            ...
            // 验证 block 块生成的代码是否正确
            it('should get code "blockly_js_func_move_stop();"', function() {
                expect('blockly_js_func_move_stop();').to.eql(code);
            });
    ...
    describe('block_event', function() {
        ...
        describe('#event_linefollower_reads', function() {
            var xml = '<xml xmlns="http://www.w3.org/1999/xhtml">\
                    <block type="event_linefollower_reads" id="En9Jk6f5b0vbelYZkVa1" x="-888" y="162">\
                        <field name="VALUE">BLACK_BLACK</field>\
                        <field name="PORT">PORT-6</field>\
                    </block>\
                </xml>';
    ...
    describe('block_detect', function() {
        ...
        describe('#detect_ultrasonic', function() {
            var xml = '<xml xmlns="http://www.w3.org/1999/xhtml">\
                <block type="detect_ultrasonic" id="0JRtW9q8bPJkRJFq6tgy" x="-787" y="112">\
                    <field name="PORT">PORT-6</field>\
                  </block>\
                </xml>';
