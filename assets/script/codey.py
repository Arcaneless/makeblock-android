...
while True:
    ...
    if typeA == 0:
        ...
        runCmd(['wrong','0000363e1c3e360000363e1c3e360000',(-90,90,0.1),(90,-90,0.2),(-90,90,0.2),(90,-90,0.1),0])
    elif typeA == 4:
        runCmd(['happy','000c18181c0c000000000c1c18180c00',(90,90,0.2),(-90,-90,0.3),(90,90,0.1),0])
    elif typeA == 5:
        runCmd(['sad','00000c1e3e3c000000003c3e1e0c0000',(-90,90,0.1),(-70,-70,0.3),(90,-90,0.3),(-70,-70,0.3),(-90,90,0.1),0])
    elif typeA == 6:
