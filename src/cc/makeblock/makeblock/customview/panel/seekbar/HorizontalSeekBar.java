  ...
  extends PercentRelativeLayout
{
  ...
  private ImageView thumb_hor_line_over;
  ...
  public HorizontalSeekBar(Context paramContext)
  {
    super(paramContext);
    init(paramContext, null, 0);
  }
  
  public HorizontalSeekBar(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    init(paramContext, paramAttributeSet, 0);
  }
  
  public HorizontalSeekBar(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private void setThumb(float paramFloat)
  {
    ...
    ViewGroup.LayoutParams localLayoutParams = this.thumb_hor_line_over.getLayoutParams();
    localLayoutParams.width = ((int)f1);
    this.thumb_hor_line_over.setLayoutParams(localLayoutParams);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.isFirst)
    {
      ...
      this.thumb_hor_line_over = ((ImageView)findViewById(2131296715));
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\cc\makeblock\makeblock\customview\panel\seekbar\HorizontalSeekBar.class
