...
public class MBotDrawPathViewModel
  ...
  implements DrawPathActionGenerator.OnRunnableRunListener
{
  ...
  public MBotDrawPathViewModel(MBot paramMBot)
  {
    super(paramMBot);
  ...
  public void play()
  {
    if (!((MBot)this.device).isConnected()) {
      return;
    }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\cc\makeblock\makeblock\viewmodel\playground\rj25\mbot\MBotDrawPathViewModel.class
