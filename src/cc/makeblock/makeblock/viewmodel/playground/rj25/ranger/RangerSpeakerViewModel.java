...
public class RangerSpeakerViewModel
  extends RangerViewModel
{
  ...
  private RecognizerListener recognizerListener = new RecognizerListener()
  {
    ...
    {
      if (RangerSpeakerViewModel.this.hasRecognized)
      {
        RangerSpeakerViewModel.access$402(RangerSpeakerViewModel.this, false);
        RangerSpeakerViewModel.this.setCurrentState(4);
      }
      do
      {
        return;
        ...
        {
          RangerSpeakerViewModel.this.setCurrentState(6);
          return;
        }
      ...
      RangerSpeakerViewModel.this.setCurrentState(5);
    }
    ...
    public void onResult(RecognizerResult paramAnonymousRecognizerResult, boolean paramAnonymousBoolean)
    {
      ...
      {
        RangerSpeakerViewModel.access$002(RangerSpeakerViewModel.this, RangerSpeakerViewModel.this.commandPinyin + str);
        if (paramAnonymousBoolean)
        {
          if (Locale.getDefault().getLanguage().equalsIgnoreCase("zh")) {
            RangerSpeakerViewModel.access$002(RangerSpeakerViewModel.this, RangerSpeakerViewModel.this.getPinYin(RangerSpeakerViewModel.this.commandPinyin));
          }
          int i = RangerSpeakerViewModel.this.getCommand(RangerSpeakerViewModel.this.commandPinyin);
          RangerSpeakerViewModel.this.executeCommand(i);
          RangerSpeakerViewModel.access$402(RangerSpeakerViewModel.this, true);
          RangerSpeakerViewModel.access$002(RangerSpeakerViewModel.this, "");
        }
        return;
      }
      RangerSpeakerViewModel.this.setCurrentState(4);
  ...
  public RangerSpeakerViewModel(Context paramContext, Ranger paramRanger)
  {
    super(paramRanger);
  ...
  private Runnable createGoBackwardRunnable()
  {
    new Runnable()
    {
      public void run()
      {
        ((Ranger)RangerSpeakerViewModel.this.device).moveJoystick(65281, 65281);
      }
    };
  }
  ...
  private Runnable createGoForwardRunnable()
  {
    new Runnable()
    {
      public void run()
      {
        ((Ranger)RangerSpeakerViewModel.this.device).moveJoystick(255, 255);
      }
    };
  }
  ...
  private Runnable createStopRunnable()
  {
    new Runnable()
    {
      public void run()
      {
        ((Ranger)RangerSpeakerViewModel.this.device).stop();
      }
    };
  }
  ...
  private Runnable createTurnLeftRunnable()
  {
    new Runnable()
    {
      public void run()
      {
        ((Ranger)RangerSpeakerViewModel.this.device).moveJoystick(65281, 255);
      }
    };
  }
  ...
  private Runnable createTurnRightRunnable()
  {
    new Runnable()
    {
      public void run()
      {
        ((Ranger)RangerSpeakerViewModel.this.device).moveJoystick(255, 65281);
      }
    };
  }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\cc\makeblock\makeblock\viewmodel\playground\rj25\ranger\RangerSpeakerViewModel.class
