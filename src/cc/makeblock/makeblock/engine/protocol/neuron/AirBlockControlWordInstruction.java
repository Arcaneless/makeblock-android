...
public class AirBlockControlWordInstruction
  extends AirBlockInstruction
{
  ...
  public AirBlockControlWordInstruction(byte paramByte, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    this.word = paramByte;
  ...
  {
    paramByteBuffer.put(NeuronByteUtil.convert8to7(1, 13));
  ...
  {
    return "AirBlock控制字指令,控制字:" + this.word + ", data1:" + this.data1 + "data2:" + this.data2 + ", data3:" + this.data3 + "data4:" + this.data4 + ", data5:" + this.data5 + "data6:" + this.data6;
  }
}


/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\cc\makeblock\makeblock\engine\protocol\neuron\AirBlockControlWordInstruction.class
