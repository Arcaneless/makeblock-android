...
public class ItemDeviceLargeBinding
  extends ViewDataBinding
{
  ...
  public ItemDeviceLargeBinding(@NonNull DataBindingComponent paramDataBindingComponent, @NonNull View paramView)
  {
  ...
  @NonNull
  public static ItemDeviceLargeBinding bind(@NonNull View paramView)
  {
    return bind(paramView, DataBindingUtil.getDefaultComponent());
  }
  
  @NonNull
  public static ItemDeviceLargeBinding bind(@NonNull View paramView, @Nullable DataBindingComponent paramDataBindingComponent)
  {
    if (!"layout/item_device_large_0".equals(paramView.getTag())) {
      throw new RuntimeException("view tag isn't correct on view:" + paramView.getTag());
    }
    return new ItemDeviceLargeBinding(paramDataBindingComponent, paramView);
  }
  
  @NonNull
  public static ItemDeviceLargeBinding inflate(@NonNull LayoutInflater paramLayoutInflater)
  {
    return inflate(paramLayoutInflater, DataBindingUtil.getDefaultComponent());
  }
  
  @NonNull
  public static ItemDeviceLargeBinding inflate(@NonNull LayoutInflater paramLayoutInflater, @Nullable DataBindingComponent paramDataBindingComponent)
  {
    return bind(paramLayoutInflater.inflate(2131427433, null, false), paramDataBindingComponent);
  }
  
  @NonNull
  public static ItemDeviceLargeBinding inflate(@NonNull LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, boolean paramBoolean)
  {
    return inflate(paramLayoutInflater, paramViewGroup, paramBoolean, DataBindingUtil.getDefaultComponent());
  }
  
  @NonNull
  public static ItemDeviceLargeBinding inflate(@NonNull LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, boolean paramBoolean, @Nullable DataBindingComponent paramDataBindingComponent)
  {
    return (ItemDeviceLargeBinding)DataBindingUtil.inflate(paramLayoutInflater, 2131427433, paramViewGroup, paramBoolean, paramDataBindingComponent);
  }
  ...
  protected void executeBindings()
  {
    try
    {
      ...
      if ((l & 0x7) != 0L)
      {
        ...
        ResourceDrawableBindings.setImageBackground(this.mboundView0, k);
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\cc\makeblock\makeblock\databinding\ItemDeviceLargeBinding.class
