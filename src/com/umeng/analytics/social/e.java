  ...
  private static String b(UMPlatformData... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        localObject = localUMPlatformData.getGender();
        str = localUMPlatformData.getName();
        if (localObject == null) {}
        try
        {
          if (TextUtils.isEmpty(str)) {
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\umeng\analytics\social\e.class
