...
public class bd
{
  ...
  public boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      localObject1 = AnalyticsConfig.getLocation();
    }
    ...
    label169:
    localObject2 = Class.forName("android.net.TrafficStats");
    Object localObject1 = ((Class)localObject2).getMethod("getUidRxBytes", new Class[] { Integer.TYPE });
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\umeng\analytics\pro\bd.class
