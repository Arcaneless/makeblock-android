...
class v
{
  ...
  {
    return "/data/data/" + paramContext.getPackageName() + "/databases/";
  }
  ...
  public static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localFile = new File("/data/data/" + paramContext.getPackageName() + "/databases/" + "ua.db");
        break label73;
      }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\umeng\analytics\pro\v.class
