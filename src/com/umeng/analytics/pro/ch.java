...
public final class ch
{
    ...
    implements Comparator
  {
    public int compare(Object paramObject1, Object paramObject2)
    {
      ...
      if ((paramObject1 instanceof List)) {
        return ch.a((List)paramObject1, (List)paramObject2);
      }
      if ((paramObject1 instanceof Set)) {
        return ch.a((Set)paramObject1, (Set)paramObject2);
      }
      if ((paramObject1 instanceof Map)) {
        return ch.a((Map)paramObject1, (Map)paramObject2);
      }
      if ((paramObject1 instanceof byte[])) {
        return ch.a((byte[])paramObject1, (byte[])paramObject2);
      }
      return ch.a((Comparable)paramObject1, (Comparable)paramObject2);
    }
  }
}


/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\umeng\analytics\pro\ch.class
