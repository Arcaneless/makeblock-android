...
public class UtilityConfig
{
  ...
  public static String getComponentUrlParam(Context paramContext)
  {
    ...
    str1 = "os.imei=" + M.a(paramContext).e("os.imei");
    str1 = str1 + ";net.mac=" + M.a(paramContext).e("net.mac");
    appendHttpParam(localStringBuffer, "device", new String(Q.a((str1 + ";unique_id=" + Y.a(paramContext)).getBytes())));
    return localStringBuffer.toString();
  }
}


/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\iflytek\speech\UtilityConfig.class
