...
public class MSC
{
  ...
  public static native int AIUIClear(char[] paramArrayOfChar);
  
  public static native int AIUIDataWrite(char[] paramArrayOfChar, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt, MSCSessionInfo paramMSCSessionInfo);
  
  public static native int AIUIGetParam(char[] paramArrayOfChar, byte[] paramArrayOfByte, MSCSessionInfo paramMSCSessionInfo);
  
  public static native int AIUIRegisterNotify(char[] paramArrayOfChar, String paramString1, String paramString2, String paramString3, String paramString4, Object paramObject);
  
  public static native int AIUISendLog(char[] paramArrayOfChar, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, MSCSessionInfo paramMSCSessionInfo);
  
  public static final native char[] AIUISessionBegin(byte[] paramArrayOfByte, MSCSessionInfo paramMSCSessionInfo);
  
  public static native int AIUISessionEnd(char[] paramArrayOfChar, byte[] paramArrayOfByte);
  
  public static native int AIUISetParam(char[] paramArrayOfChar, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2);
  
  public static native int AIUISyncData(char[] paramArrayOfChar, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, MSCSessionInfo paramMSCSessionInfo);
  ...
  public static boolean loadLibrary(String paramString)
  {
    ...
    try
    {
      ...
      a = true;
      ad.a("loadLibrary " + paramString + " success");
      return a;
    }
    catch (UnsatisfiedLinkError localUnsatisfiedLinkError)
    {
      for (;;)
      {
        ad.b("loadLibrary " + paramString + " error:" + localUnsatisfiedLinkError);
        a = false;
      }
    }
  }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\iflytek\msc\MSC.class
