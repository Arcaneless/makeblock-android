  ...
  implements JsonSerializer<java.util.Date>, JsonDeserializer<java.util.Date>
{
  ...
  private java.util.Date deserializeToDate(JsonElement paramJsonElement)
  {
    ...
    try
    {
      localDate3 = ISO8601Utils.parse(paramJsonElement.getAsString(), new ParsePosition(0));
      return localDate3;
    }
    catch (ParseException localParseException3)
    {
      java.util.Date localDate3;
      for (;;) {}
    }
    throw new JsonSyntaxException(paramJsonElement.getAsString(), localDate3);
  }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\google\gson\DefaultDateTypeAdapter.class
