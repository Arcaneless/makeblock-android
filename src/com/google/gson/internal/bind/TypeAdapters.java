...
public final class TypeAdapters
{
    ...
    extends TypeAdapter<T>
  {
    ...
    public EnumTypeAdapter(Class<T> paramClass)
    {
      ...
      Object localObject1 = ((Enum)localObject2).name();
      Object localObject3 = (SerializedName)paramClass.getField((String)localObject1).getAnnotation(SerializedName.class);
      for (;;)
      {
        str = ((SerializedName)localObject3).value();
        localObject3 = ((SerializedName)localObject3).alternate();
        m = localObject3.length;
        j = 0;
        break label185;
        this.nameToConstant.put(localObject1, localObject2);
        break label204;
        label116:
        do
        {
          this.nameToConstant.put(localObject1, localObject2);
          this.constantToName.put(localObject2, localObject1);
          i += 1;
          while (i >= k) {
            return;
          }
          localObject2 = arrayOfEnum[i];
          break;
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\google\gson\internal\bind\TypeAdapters.class
