  ...
  implements TextWatcher, View.OnClickListener
{
  ...
  public h(Context paramContext, UnityPlayer paramUnityPlayer, String paramString1, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString2)
  {
    super(paramContext);
    this.a = paramContext;
  ...
  private static int a(int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    label63:
    return i | new int[] { 1, 16385, 12290, 17, 2, 3, 8289, 33 }[paramInt];
  }
  ...
  protected final View createSoftInputView()
  {
    ...
    Object localObject = new EditText(this.a)
    {
      ...
      public final void onWindowFocusChanged(boolean paramAnonymousBoolean)
      {
        ...
        if (paramAnonymousBoolean) {
          ((InputMethodManager)h.b(h.this).getSystemService("input_method")).showSoftInput(this, 0);
        }
      }
    };
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\unity3d\player\h.class
