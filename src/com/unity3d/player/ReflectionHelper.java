...
final class ReflectionHelper
{
  ...
  private static Class a(String paramString, int[] paramArrayOfInt)
  {
    while (paramArrayOfInt[0] < paramString.length())
    {
      ...
      e.Log(5, "! parseType; " + c + " is not known!");
    }
    return null;
  }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\unity3d\player\ReflectionHelper.class
