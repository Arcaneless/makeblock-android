  ...
  implements PageIndicator
{
  ...
  public CirclePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    float f3 = ((Resources)localObject).getDimension(R.dimen.default_circle_indicator_gap);
    ...
    this.mGap = paramAttributeSet.getDimension(R.styleable.CirclePageIndicator_gap, f3);
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (this.mOrientation == 0)
    {
      ...
      i = getPaddingRight();
      m = getPaddingTop();
      f6 = this.mRadius * 3.0F + this.mGap;
      f1 = m + this.mRadius;
      f3 = j + this.mRadius;
      f2 = f3;
      if (this.mCentered) {
        f2 = f3 + (k - j - i - (n * f6 - this.mRadius - this.mGap)) / 2.0F;
      }
      f4 = this.mRadius;
      f3 = f4;
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\viewpagerindicator\CirclePageIndicator.class
