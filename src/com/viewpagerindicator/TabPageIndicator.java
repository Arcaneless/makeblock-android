  ...
  implements PageIndicator
{
  ...
  public TabPageIndicator(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.TabPageIndicator);
    this.mIconDirection = paramAttributeSet.getInteger(R.styleable.TabPageIndicator_vpi_iconDirection, 0);
    this.mIconWidth = paramAttributeSet.getDimensionPixelSize(R.styleable.TabPageIndicator_vpi_iconWidth, 0);
    this.mIconHeight = paramAttributeSet.getDimensionPixelSize(R.styleable.TabPageIndicator_vpi_iconHeight, 0);
  ...
  private void addTab(int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    ...
    if (paramInt2 != 0)
    {
      paramCharSequence = getResources().getDrawable(paramInt2);
      ...
      paramCharSequence.setBounds(0, 0, this.mIconWidth, this.mIconHeight);
      switch (this.mIconDirection)
      {
      default: 
        localTabView.setCompoundDrawables(null, null, null, paramCharSequence);
      }
    }
    for (;;)
    {
      ...
      return;
      label141:
      paramCharSequence.setBounds(0, 0, this.mIconWidth, this.mIconWidth * paramCharSequence.getIntrinsicHeight() / paramCharSequence.getIntrinsicWidth());
      break;
      label168:
      if (this.mIconHeight != 0)
      {
        paramCharSequence.setBounds(0, 0, this.mIconHeight * paramCharSequence.getIntrinsicWidth() / paramCharSequence.getIntrinsicHeight(), this.mIconHeight);
        break;
      }
      paramCharSequence.setBounds(0, 0, paramCharSequence.getIntrinsicWidth(), paramCharSequence.getIntrinsicHeight());
      break;
      localTabView.setCompoundDrawables(paramCharSequence, null, null, null);
      continue;
      localTabView.setCompoundDrawables(null, null, paramCharSequence, null);
      continue;
      localTabView.setCompoundDrawables(null, paramCharSequence, null, null);
    }
  }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\com\viewpagerindicator\TabPageIndicator.class
