    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      if (i < k)
      {
        ...
        do
        {
          ...
          } while (this.dimensionRatio == null);
        ...
        } while ((paramAttributeSet.length() <= 0) || (str.length() <= 0));
      }
      for (;;)
      {
        float f1;
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\constraint\ConstraintLayout.class
