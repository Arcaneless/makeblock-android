...
public final class AppCompatResources
{
  ...
  private static void addColorStateListToCache(@NonNull Context paramContext, @ColorRes int paramInt, @NonNull ColorStateList paramColorStateList)
  {
    for (;;)
    {
      ...
      {
        localSparseArray2 = (SparseArray)sColorStateCaches.get(paramContext);
        break label70;
  ...
  private static ColorStateList getCachedColorStateList(@NonNull Context paramContext, @ColorRes int paramInt)
  {
    for (;;)
    {
      ColorStateListCacheEntry localColorStateListCacheEntry;
      synchronized (sColorStateCacheLock)
      {
        SparseArray localSparseArray = (SparseArray)sColorStateCaches.get(paramContext);
        if ((localSparseArray != null) && (localSparseArray.size() > 0))
        {
          localColorStateListCacheEntry = (ColorStateListCacheEntry)localSparseArray.get(paramInt);
          break label84;
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v7\content\res\AppCompatResources.class
