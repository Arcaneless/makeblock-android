  ...
  implements CollapsibleActionView
{
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      str = SuggestionsAdapter.getColumnString(paramCursor, "suggest_intent_extra_data");
      break;
      return createIntent((String)localObject2, (Uri)localObject1, str, (String)localObject3, paramInt, paramString);
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v7\widget\SearchView.class
