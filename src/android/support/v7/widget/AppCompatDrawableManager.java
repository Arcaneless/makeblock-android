...
public final class AppCompatDrawableManager
{
  ...
  private Drawable getCachedDrawable(@NonNull Context paramContext, long paramLong)
  {
    for (;;)
    {
      ...
      synchronized (this.mDrawableCacheLock)
      {
        ...
        break label89;
        return null;
        localObject2 = (WeakReference)localLongSparseArray.get(paramLong);
        break label97;
        label44:
  ...
  private Drawable loadDrawableFromDelegates(@NonNull Context paramContext, @DrawableRes int paramInt)
  {
    ...
    label244:
    label266:
    InflateDelegate localInflateDelegate;
    if ((this.mDelegates != null) && (!this.mDelegates.isEmpty()))
    {
      ...
      localObject3 = localObject1;
      localInflateDelegate = (InflateDelegate)this.mDelegates.get(localObject2);
      break label404;
      label314:
      localObject3 = localObject1;
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v7\widget\AppCompatDrawableManager.class
