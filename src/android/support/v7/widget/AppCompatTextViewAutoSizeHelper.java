...
class AppCompatTextViewAutoSizeHelper
{
  ...
  private Method getTextViewMethod(@NonNull String paramString)
  {
    try
    {
      localMethod3 = (Method)sTextViewMethodByNameCache.get(paramString);
    }
    ...
    Method localMethod3 = TextView.class.getDeclaredMethod(paramString, new Class[0]);
    for (;;)
    {
      localMethod3.setAccessible(true);
      sTextViewMethodByNameCache.put(paramString, localMethod3);
      Method localMethod1 = localMethod3;
      do
      {
        do
        {
        ...
        } while (localMethod3 != null);
        break;
        Method localMethod2 = localMethod3;
      } while (localMethod3 == null);
    }
  }
  ...
  private void setRawTextSize(float paramFloat)
  {
    ...
    try
    {
      localMethod = getTextViewMethod("nullLayouts");
    }
    catch (Exception localException)
    {
      for (;;)
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v7\widget\AppCompatTextViewAutoSizeHelper.class
