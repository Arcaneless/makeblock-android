      ...
      implements IMediaSession
    {
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          ...
          return;
          localParcel1.writeInt(0);
          while (paramResultReceiverWrapper == null)
          {
            localParcel1.writeInt(0);
            break label55;
            if (paramBundle == null) {
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v4\media\session\IMediaSession.class
