      ...
      public ParcelableVolumeInfo getVolumeAttributes()
      {
        for (;;)
        {
          ...
          synchronized (MediaSessionCompat.MediaSessionImplBase.this.mLock)
          {
            ...
            break label117;
            int i = localVolumeProviderCompat.getVolumeControl();
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v4\media\session\MediaSessionCompat.class
