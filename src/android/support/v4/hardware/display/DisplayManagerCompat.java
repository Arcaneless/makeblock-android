...
public abstract class DisplayManagerCompat
{
  ...
  public static DisplayManagerCompat getInstance(Context paramContext)
  {
    for (;;)
    {
      DisplayManagerCompat localDisplayManagerCompat;
      synchronized (sInstances)
      {
        localDisplayManagerCompat = (DisplayManagerCompat)sInstances.get(paramContext);
        break label67;
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v4\hardware\display\DisplayManagerCompat.class
