  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner
{
  ...
  public static Fragment instantiate(Context paramContext, String paramString, @Nullable Bundle paramBundle)
  {
    ...
    try
    {
      localClass2 = (Class)sClassMap.get(paramString);
    }
    ...
    Class localClass1 = paramContext.getClassLoader().loadClass(paramString);
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v4\app\Fragment.class
