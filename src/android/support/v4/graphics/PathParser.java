...
public class PathParser
{
  ...
  private static float[] getFloats(String paramString)
  {
    ...
    localExtractFloatResult = new ExtractFloatResult();
    int n = paramString.length();
    break label152;
    int j;
    extract(paramString, j, localExtractFloatResult);
    int k = localExtractFloatResult.mEndPosition;
    break label163;
    label69:
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\android\support\v4\graphics\PathParser.class
