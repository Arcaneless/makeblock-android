...
final class Hpack
{
  ...
  static final class Writer
  {
    ...
    Writer(int paramInt, Buffer paramBuffer)
    {
      ...
      throws IOException
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          int k = Util.indexOf(this.dynamicTable, localHeader);
          if (k != -1)
          {
            writeInt(k - this.nextHeaderIndex + Hpack.STATIC_HEADER_TABLE.length, 127, 128);
          }
          else
          {
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\okhttp3\internal\framed\Hpack.class
