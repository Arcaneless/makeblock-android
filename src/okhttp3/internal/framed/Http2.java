    ...
    implements FrameReader
  {
      ...
      throws IOException
    {
      ...
      do
      {
        ...
        if (Http2.logger.isLoggable(Level.FINE)) {
          Http2.logger.fine(Util.format("<< CONNECTION %s", new Object[] { localByteString.hex() }));
        }
    ...
    implements FrameWriter
  {
      ...
      throws IOException
    {
      ...
      for (;;)
      {
        return;
        if (Http2.logger.isLoggable(Level.FINE)) {
          Http2.logger.fine(Util.format(">> CONNECTION %s", new Object[] { Http2.CONNECTION_PREFACE.hex() }));
        }
      ...
      throws IOException
    {
      ...
      for (;;)
      {
        frameHeader(0, i + 8, (byte)7, (byte)0);
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\okhttp3\internal\framed\Http2.class
