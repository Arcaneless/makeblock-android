...
public class Completable
{
  ...
  {
    this.onSubscribe = HOOK.onCreate(paramCompletableOnSubscribe);
  }
      ...
      public void call(final Completable.CompletableSubscriber paramAnonymousCompletableSubscriber)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            localCompletable.unsafeSubscribe(localThrowable3);
          }
        }
      }
    });
    ...
    create(new CompletableOnSubscribe()
    {
      public void call(final Completable.CompletableSubscriber paramAnonymousCompletableSubscriber)
      {
        ...
        for (;;)
        {
          ...
          localCompletable.unsafeSubscribe((Completable.CompletableSubscriber)localObject);
          i += 1;
        }
      }
    });
  ...
  public static Completable defer(Func0<? extends Completable> paramFunc0)
  {
    ...
    create(new CompletableOnSubscribe()
    {
      public void call(Completable.CompletableSubscriber paramAnonymousCompletableSubscriber)
      {
        ...
        localThrowable.unsafeSubscribe(paramAnonymousCompletableSubscriber);
      }
    });
  }
  ...
  private final <T> void unsafeSubscribe(final Subscriber<T> paramSubscriber, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      RxJavaPlugins.getInstance().getObservableExecutionHook().onSubscribeReturn(paramSubscriber);
      return;
    }
    ...
    catch (Throwable paramSubscriber)
    {
      ...
      paramSubscriber = HOOK.onSubscribeError(paramSubscriber);
    ...
    create(new CompletableOnSubscribe()
    {
      public void call(final Completable.CompletableSubscriber paramAnonymousCompletableSubscriber)
      {
        try
        {
          ...
          Completable localCompletable;
          localThrowable4.unsafeSubscribe(new Completable.CompletableSubscriber()
          {
            Subscription d;
  ...
  public final Completable delay(final long paramLong, TimeUnit paramTimeUnit, final Scheduler paramScheduler, final boolean paramBoolean)
  {
    ...
    create(new CompletableOnSubscribe()
    {
      public void call(final Completable.CompletableSubscriber paramAnonymousCompletableSubscriber)
      {
        ...
        Completable.this.unsafeSubscribe(new Completable.CompletableSubscriber()
        {
          public void onCompleted()
          {
  ...
  public final Completable lift(final CompletableOperator paramCompletableOperator)
  {
    ...
    create(new CompletableOnSubscribe()
    {
      public void call(Completable.CompletableSubscriber paramAnonymousCompletableSubscriber)
      {
        try
        {
          paramAnonymousCompletableSubscriber = (Completable.CompletableSubscriber)Completable.HOOK.onLift(paramCompletableOperator).call(paramAnonymousCompletableSubscriber);
          Completable.this.unsafeSubscribe(paramAnonymousCompletableSubscriber);
          return;
        }
      ...
      public void call(final Completable.CompletableSubscriber paramAnonymousCompletableSubscriber)
      {
        ...
        Completable.this.unsafeSubscribe(new Completable.CompletableSubscriber()
        {
          ...
          public void onError(Throwable paramAnonymous2Throwable)
          {
            ...
            localThrowable.unsafeSubscribe(new Completable.CompletableSubscriber()
            {
              public void onCompleted()
              {
  ...
  public final Subscription subscribe(final Action1<? super Throwable> paramAction1, final Action0 paramAction0)
  {
    ...
    unsafeSubscribe(new CompletableSubscriber()
    {
      ...
      /* Error */
      void callOnError(Throwable paramAnonymousThrowable)
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 31	rx/Completable$27:val$onError	Lrx/functions/Action1;
        //   4: aload_1
        //   5: invokeinterface 45 2 0
        //   10: aload_0
        //   11: getfield 29	rx/Completable$27:val$mad	Lrx/subscriptions/MultipleAssignmentSubscription;
        //   14: invokevirtual 50	rx/subscriptions/MultipleAssignmentSubscription:unsubscribe	()V
        //   17: return
        //   18: astore_2
        //   19: new 52	rx/exceptions/CompositeException
        //   22: dup
        //   23: iconst_2
        //   24: anewarray 39	java/lang/Throwable
        //   27: dup
        //   28: iconst_0
        //   29: aload_1
        //   30: aastore
        ...
        //   38: invokespecial 61	rx/exceptions/CompositeException:<init>	(Ljava/util/Collection;)V
        //   41: astore_1
        //   42: getstatic 65	rx/Completable:ERROR_HANDLER	Lrx/plugins/RxJavaErrorHandler;
        //   45: aload_1
        //   46: invokevirtual 70	rx/plugins/RxJavaErrorHandler:handleError	(Ljava/lang/Throwable;)V
        //   49: aload_1
        //   50: invokestatic 73	rx/Completable:access$000	(Ljava/lang/Throwable;)V
        //   53: aload_0
        //   54: getfield 29	rx/Completable$27:val$mad	Lrx/subscriptions/MultipleAssignmentSubscription;
        //   57: invokevirtual 50	rx/subscriptions/MultipleAssignmentSubscription:unsubscribe	()V
        //   60: return
        //   61: astore_1
        //   62: aload_0
        //   63: getfield 29	rx/Completable$27:val$mad	Lrx/subscriptions/MultipleAssignmentSubscription;
        //   66: invokevirtual 50	rx/subscriptions/MultipleAssignmentSubscription:unsubscribe	()V
        //   69: aload_1
        //   70: athrow
        //   71: astore_1
        //   72: goto -10 -> 62
      ...
      public void onError(Throwable paramAnonymousThrowable)
      {
        ...
        {
          this.done = true;
          callOnError(paramAnonymousThrowable);
          return;
        }
        Completable.ERROR_HANDLER.handleError(paramAnonymousThrowable);
        Completable.deliverUncaughtException(paramAnonymousThrowable);
  ...
  {
    Object localObject = paramCompletableSubscriber;
    if (!(paramCompletableSubscriber instanceof SafeCompletableSubscriber)) {
      localObject = new SafeCompletableSubscriber(paramCompletableSubscriber);
    }
    unsafeSubscribe((CompletableSubscriber)localObject);
  }
  ...
  public final <T> void subscribe(Subscriber<T> paramSubscriber)
  {
    ...
    unsafeSubscribe((Subscriber)localObject, false);
  }
  ...
  public final <T> Observable<T> toObservable()
  {
    Observable.create(new Observable.OnSubscribe()
    {
      ...
      {
        Completable.this.unsafeSubscribe(paramAnonymousSubscriber);
      }
    });
  }
  ...
  public final void unsafeSubscribe(CompletableSubscriber paramCompletableSubscriber)
  {
    ...
    try
    {
      HOOK.onSubscribeStart(this, this.onSubscribe).call(paramCompletableSubscriber);
      return;
    }
    ...
    {
      Exceptions.throwIfFatal(paramCompletableSubscriber);
      paramCompletableSubscriber = HOOK.onSubscribeError(paramCompletableSubscriber);
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\rx\Completable.class
