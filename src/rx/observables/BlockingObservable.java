...
public final class BlockingObservable<T>
{
  ...
  public void subscribe(Observer<? super T> paramObserver)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject3 = localLinkedBlockingQueue.poll();
      }
  ...
  public void subscribe(Subscriber<? super T> paramSubscriber)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = localLinkedBlockingQueue.poll();
        break label199;
        Object localObject1 = localLinkedBlockingQueue.take();
        if ((paramSubscriber.isUnsubscribed()) || (localObject1 == UNSUBSCRIBE)) {
          continue;
        }
      ...
      boolean bool = localNotificationLite.accept(paramSubscriber, localInterruptedException);
      if (bool)
      {
        local6.unsubscribe();
        return;
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\rx\observables\BlockingObservable.class
