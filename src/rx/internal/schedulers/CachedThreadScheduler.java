  ...
  implements SchedulerLifecycle
{
  ...
  private static final class CachedWorkerPool
  {
    ...
    CachedWorkerPool(final ThreadFactory paramThreadFactory, long paramLong, TimeUnit paramTimeUnit)
    {
      this.threadFactory = paramThreadFactory;
      ...
      for (paramLong = paramTimeUnit.toNanos(paramLong);; paramLong = 0L)
      {
        ...
        if (paramTimeUnit != null)
        {
          localScheduledExecutorService = Executors.newScheduledThreadPool(1, new ThreadFactory()
          {
            public Thread newThread(Runnable paramAnonymousRunnable)
            {
              paramAnonymousRunnable = paramThreadFactory.newThread(paramAnonymousRunnable);
              paramAnonymousRunnable.setName(paramAnonymousRunnable.getName() + " (Evictor)");
    ...
    CachedThreadScheduler.ThreadWorker get()
    {
      ...
      CachedThreadScheduler.ThreadWorker localThreadWorker = new CachedThreadScheduler.ThreadWorker(this.threadFactory);
    ...
    extends Scheduler.Worker
  {
    ...
    public Subscription schedule(final Action0 paramAction0, long paramLong, TimeUnit paramTimeUnit)
    {
      ...
      paramAction0 = this.threadWorker.scheduleActual(new Action0()
      {
        public void call()
        {
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\rx\internal\schedulers\CachedThreadScheduler.class
