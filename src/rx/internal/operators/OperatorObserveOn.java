  ...
  implements Observable.Operator<T, T>
{
  ...
  public static <T> Observable.Operator<T, T> rebatch(int paramInt)
  {
    new Observable.Operator()
    {
      ...
      {
        paramAnonymousSubscriber = new OperatorObserveOn.ObserveOnSubscriber(Schedulers.immediate(), paramAnonymousSubscriber, false, this.val$n);
        paramAnonymousSubscriber.init();
        return paramAnonymousSubscriber;
      }
    };
  }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\rx\internal\operators\OperatorObserveOn.class
