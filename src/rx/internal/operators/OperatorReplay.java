  ...
  extends ConnectableObservable<T>
{
    ...
    implements Subscription
  {
          ...
          if (!OperatorReplay.ReplaySubscriber.this.terminated) {
            synchronized (OperatorReplay.ReplaySubscriber.this.producers)
            {
              if (!OperatorReplay.ReplaySubscriber.this.terminated)
              {
                ...
                localReplaySubscriber.producersVersion += 1L;
    ...
    {
      long l = this.maxUpstreamRequested;
      ...
      if (paramLong2 != 0L)
      {
        ...
        if (localProducer != null) {
          if (l != 0L)
          {
            ...
            localProducer.request(l + paramLong2);
          }
        }
      }
      while ((l == 0L) || (localProducer == null))
      {
        return;
        localProducer.request(paramLong2);
        return;
        ...
        this.maxUpstreamRequested = paramLong1;
        return;
      }
      this.maxUpstreamRequested = 0L;
      localProducer.request(l);
    }
    ...
    void manageRequests(OperatorReplay.InnerProducer<T> paramInnerProducer)
    {
      ...
      for (;;)
      {
        ...
        this.coordinationQueue = ((List)localObject);
        label74:
        label205:
        label373:
        do
        {
          ((List)localObject).add(paramInnerProducer);
          this.missed = true;
          return;
          do
          {
            ...
            if (paramInnerProducer != null)
            {
              l2 = Math.max(l3, paramInnerProducer.totalRequested.get());
              makeRequest(l2, l3);
            }
            for (;;)
            {
              ...
              long l1 = l3;
              paramInnerProducer = copyProducers();
              int j = paramInnerProducer.length;
              int i = 0;
              for (;;)
              {
                l2 = l1;
                ...
                localObject = paramInnerProducer[i];
                l2 = l1;
                if (localObject != null) {
                  l2 = Math.max(l1, ((OperatorReplay.InnerProducer)localObject).totalRequested.get());
                }
                i += 1;
                l1 = l2;
              }
              this.missed = false;
              paramInnerProducer = this.coordinationQueue;
              this.coordinationQueue = null;
              boolean bool = this.coordinateAll;
              this.coordinateAll = false;
              l3 = this.maxChildRequested;
              l2 = l3;
              l1 = l2;
              if (paramInnerProducer != null)
              {
                paramInnerProducer = paramInnerProducer.iterator();
                for (;;)
                {
                  l1 = l2;
                  if (!paramInnerProducer.hasNext()) {
                    break;
                  }
                  l2 = Math.max(l2, ((OperatorReplay.InnerProducer)paramInnerProducer.next()).totalRequested.get());
                }
              }
              l2 = l1;
              if (bool)
    ...
    void replay()
    {
      Object localObject1 = this.producersCache;
      if (this.producersCacheVersion != this.producersVersion) {}
      synchronized (this.producers)
      {
        Object localObject3 = this.producersCache;
        Object[] arrayOfObject = this.producers.values();
        int i = arrayOfObject.length;
        localObject1 = localObject3;
        if (localObject3.length != i)
        {
          localObject1 = new OperatorReplay.InnerProducer[i];
          this.producersCache = ((OperatorReplay.InnerProducer[])localObject1);
        }
        System.arraycopy(arrayOfObject, 0, localObject1, 0, i);
        ...
        if (i < j)
        {
          ??? = localObject1[i];
          if (??? != null) {
            ((OperatorReplay.ReplayBuffer)localObject3).replay(???);
          }
          i += 1;
        }
      }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\rx\internal\operators\OperatorReplay.class
