  ...
  implements Observable.Operator<Observable<T>, T>
{
    ...
    extends Subscriber<T>
  {
    ...
    void endWindow(OperatorWindowWithStartEndObservable.SerializedSubject<T> paramSerializedSubject)
    {
      ...
      {
        int i;
        OperatorWindowWithStartEndObservable.SerializedSubject localSerializedSubject;
        synchronized (this.guard)
        {
          if (this.done) {
            return;
          ...
          {
            localSerializedSubject = (OperatorWindowWithStartEndObservable.SerializedSubject)localIterator.next();
            break label91;
        ...
        return;
        label91:
        if (localSerializedSubject == paramSerializedSubject) {
          i = 1;
        }
      }
    }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\rx\internal\operators\OperatorWindowWithStartEndObservable.class
