  ...
  implements Observable.Operator<Observable<T>, T>
{
    ...
    extends Subscriber<T>
  {
    ...
    void terminateChunk(OperatorWindowWithTime.CountedSerializedSubject<T> paramCountedSerializedSubject)
    {
      ...
      {
        int i;
        OperatorWindowWithTime.CountedSerializedSubject localCountedSerializedSubject;
        synchronized (this.guard)
        {
          if (this.done) {
            return;
          ...
          {
            localCountedSerializedSubject = (OperatorWindowWithTime.CountedSerializedSubject)localIterator.next();
            break label91;
            localIterator.remove();
          }
          if (i != 0)
        ...
        return;
        label91:
        if (localCountedSerializedSubject == paramCountedSerializedSubject) {
          i = 1;
        }
      }
    }
...
/* Location:              C:\Users\Marcus Cheung\Desktop\AndriodHacking\Makeblock_v3.0.8_apkpure.com-dex2jar.jar!\rx\internal\operators\OperatorWindowWithTime.class
